...
* Website của bạn cần đăng kí một URL để nhận trạng thái đơn hàng cập nhật từ Nhanh.vn \(cập nhật realtime khi trạng thái đơn hàng thay đổi bên trong Nhanh.vn\). Xem thêm [Config webhooks](https://developers.nhanh.vn/send-data-to-nhanh.vn/link)
