...
[
    ...
    “available”: int // số lượng có thể bán (sử dụng để hiển <br> thị trên website, chặn đặt hàng khi hết số <br>tồn hoặc vượt quá số tồn).
    // Tồn tại từng kho
    “depots”: [
        “depotId” => [
        “remain”: int // số lượng tồn kho
        ...
        “holding”: int // số lượng đang tạm giữ
        “damage”: int //  số lượng lỗi
        “available”: int // số lượng có thể bán (sử dụng để <br>hiển thị trên website, chặn đặt hàng khi hết số<br> tồn hoặc vượt quá số tồn).
        ],
        “depotId” => [
        ...
        ],
