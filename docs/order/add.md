...
status | string | No | Trạng thái của đơn hàng: New (Mới) hoặc Confirmed (Đã xác nhận). Xem thêm các trạng thái khi nhận cập nhật từ Nhanh.vn [tại đây](https://developers.nhanh.vn/glossary.html#order-status)
