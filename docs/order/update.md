...
status | string | No | Trạng thái đơn hàng, có thể là:<br> Confirmed // Đã xác nhận<br>- Canceled // Khách huỷ(chỉ đổi được sang trạng thái Khách hủy khi đơn hàng đang ở trạng thái Mới, Đang xác nhận, Đã xác nhận)<br>- Aborted // Hệ thống hủy (chỉ đổi được sang trạng thái khi đơn hàng đang ở trạng thái Mới, Đang xác nhận, Đã xác nhận)
