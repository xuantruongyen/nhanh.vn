...
status | string | No | Trạng thái đơn hàng, có thể là:<br>Confirmed // Đã xác nhận<br>Canceled // chỉ đổi được sang trạng thái Khách hủy khi đơn hàng đang ở trạng thái Mới, Đang xác nhận, Đã xác nhận<br>Aborted // Hệ thống hủy khi đơn hàng đang ở trạng thái Mới, Đang xác nhận, Đã xác nhận
